...
// Physical Channel (Where something is actually located in the format) 
...
// Logical Channels (Channel usage regardless of actual position)
...
pub const Format = enum(u8) {
    ...
    A2R10G10B10_SNORM = 79,
    A2R10G10B10_UINT = 80,
    A2R10G10B10_SINT = 81,
    A2B10G10R10_UNORM = 82,
    A2B10G10R10_SNORM = 83,
    A2B10G10R10_UINT = 84,
    A2B10G10R10_SINT = 85,
    R10G10B10A2_UNORM = 86,
    R10G10B10A2_SNORM = 87,
    R10G10B10A2_UINT = 88,
    R10G10B10A2_SINT = 89,
    B10G10R10A2_UNORM = 90,
    B10G10R10A2_SNORM = 91,
    B10G10R10A2_UINT = 92,
    B10G10R10A2_SINT = 93,
    B10G11R11_UFLOAT = 94,
    E5_UINT_B9G9R9_UFLOAT = 95,
    R16G16B16_UNORM = 96,
    R16G16B16_SNORM = 97,
    R16G16B16_UINT = 98,
    R16G16B16_SINT = 99,
    ...
    R32G32B32_UINT = 114,
    R32G32B32_SINT = 115,
    R32G32B32_SFLOAT = 116,
    R32G32B32A32_UINT = 117,
    R32G32B32A32_SINT = 118,
    R32G32B32A32_SFLOAT = 119,
    R64G64_UINT = 120,
    R64G64_SINT = 121,
    R64G64_SFLOAT = 122,
    R64G64B64_UINT = 123,
    ...
    ASTC_10x8_UNORM = 188,
    ASTC_10x8_SRGB = 189,
    ASTC_10x10_UNORM = 190,
    ASTC_10x10_SRGB = 191,
    ASTC_12x10_UNORM = 192,
    ASTC_12x10_SRGB = 193,
    ASTC_12x12_UNORM = 194,
    ASTC_12x12_SRGB = 195,
    CLUT_P4 = 196,
    CLUT_P4A4 = 197,
    CLUT_P8 = 198,
